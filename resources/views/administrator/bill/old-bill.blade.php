...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		...
		@endphp
		<div style="border: none; border-left: 0.25rem solid; border-color: #005D64;" class="card bill-info mb-5 py-0 ">
			<div class="card-body p-1">
				<div style="color: {{$color[0]}}; text-decoration: underline;" class="font-weight-bold">
					<img width="81" src="{{asset('public/media/img-icons/gift-box.png')}}">Mã HĐ : {{$bill_pro->bills_bill_id}}
				</div>

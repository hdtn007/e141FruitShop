          ...
          <div class="carousel-inner">
            <div class="item active">
              <div class="col-sm-6">
                ...
                <h2>MUA NHANH - GIAO TẬN NƠI</h2>
                <p>141Fruits cung cấp đầy đủ các sản phẩm rau củ quả, trái cây, bánh kẹo và thịt sữa nhập khẩu. Những sản phẩm, quà tặng cao cấp đến cho mọi người, giao hàng nhanh chống, thanh toán tiện lợi online !. </p>
                <button type="button" class="btn btn-default get">Mua Ngay</button>
              </div>
              <div class="col-sm-6">
                <img src="{{('customer/images/home/Logo141Fruits.png')}}" class="girl img-responsive" alt="" />
                <!-- <img src="{{('customer/images/home/crazy-cart.gif')}}"  class="pricing" alt="" /> -->
              </div>
            </div>
            <div class="item">
              <div class="col-sm-6">
      ...
      <div class="col-sm-3">
        <div class="left-sidebar">
          ...
          <div class="shipping text-center"><!--shipping-->
            <img src="{{('customer/images/banner/banner1.jpg')}}" alt="" />
          </div><!--/shipping-->
            ...
            <div class="product-image-wrapper">
              <div class="single-products">
                <div class="productinfo text-center">
                  <img src="{{('customer/images/product/chuoi.png')}}" alt="" />
                  ...
                  <div>
                    <ul class="nav nav-pills nav-justified">
                      <li title="Yêu thích"><center><a class="btn btn-default product-like"><i class="fa fa-heart"></i></a></center></li>
                      <li title="Thêm vào giỏ hàng"><center><a class="btn btn-default add-to-cart"><i class="glyphicon glyphicon-plus"></i></a></center></li>
                    </ul>
                  </div>

                </div>
                <img src="{{('customer/images/icons/new.png')}}" class="new" alt="" />
              </div>
              <div class="choose">
                <ul class="nav nav-pills nav-justified">
                  <li title="0 lượt yêu thích" style="border-right: 0.5px solid #F9F9F9;"><a class="count-like">0 <img src="{{('customer/images/icons/heart.png')}}" alt="" /></a></li>
          ...
          <div class="col-sm-4">
            <div class="product-image-wrapper">
              <div class="single-products">
                ...
                <img src="{{('customer/images/icons/sale.png')}}" class="new" alt="" />
              </div>
              <div class="choose">
                <ul class="nav nav-pills nav-justified">
                  <li title="0 lượt yêu thích" style="border-right: 0.5px solid #F9F9F9;"><a class="count-like">0 <img src="{{('customer/images/icons/heart.png')}}" alt="" /></a></li>
